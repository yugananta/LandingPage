...
export default function DownloadApp() {
  return (
    <section className="py-12 bg-[#0c0e18] text-white px-margin-desktop md:px-margin-desktop px-margin-mobile border-t border-b border-white/10 relative z-20">
      <div className="max-w-container-max mx-auto flex flex-col items-center justify-center text-center gap-5">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-indigo-400/30 bg-indigo-500/10 text-indigo-300 text-[10px] font-bold uppercase tracking-widest">
          <span className="material-symbols-outlined text-xs">phone_iphone</span>
          DOWNLOAD MOBILE APP
        </div>
        <div className="flex flex-row items-center justify-center gap-4 flex-wrap">
          <a href="#" className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-b from-[#181b30] to-[#121424] hover:from-[#1e233d] hover:to-[#16192c] text-white border border-white/10 hover:border-indigo-500/40 transition-all shadow-xl group">
            <div className="w-9 h-9 rounded-xl bg-indigo-500/15 border border-indigo-500/25 flex items-center justify-center shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
          ...
          <a href="#" className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-b from-[#181b30] to-[#121424] hover:from-[#1e233d] hover:to-[#16192c] text-white border border-white/10 hover:border-indigo-500/40 transition-all shadow-xl group">
            <div className="w-9 h-9 rounded-xl bg-indigo-500/15 border border-indigo-500/25 flex items-center justify-center shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition-colors">
              <svg viewBox="0 0 512 512" className="w-4 h-4 fill-current text-indigo-300 group-hover:text-white transition-transform group-hover:scale-110">
